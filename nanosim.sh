...
do 
    ...
    dna_type=${line[2]}
    no_of_reads=${line[3]}
    x = ../../Simtools/NanoSim/src/simulator.py genome -rg $file_path -c ../../Simtools/NanoSim/pre-trained_models/metagenome_ERR3152364_Even/training -dna_type $dna_type -o human/reads/$file_name  -n  $no_of_reads 
    printf "------------------"
    printf "$x\n"
